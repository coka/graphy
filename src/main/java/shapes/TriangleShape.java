...
public class TriangleShape extends AbstractShape
{
  ...
  public TriangleShape(Vec2f position, Color stroke, Color fill, float size)
  {
  ...
  public TriangleShape(Vec2f position, Color stroke, Color fill, float width, float height)
  {
    super(position, stroke, fill);
    this.width  = width ;
    this.height = height;
